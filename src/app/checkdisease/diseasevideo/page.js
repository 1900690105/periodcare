...
import { translations } from "@/app/data/Disease";
...
const DiseaseDetailView = ({
  ...
  const diseaseData = translations[language][disease.id];
      ...
      <div className="min-h-screen py-8 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
            {/* Header */}
            <div className="bg-linear-to-r from-pink-500 to-purple-500 p-8 text-white relative">
              <button
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-4xl font-bold mb-2">{disease.name}</h2>
                  <p className="text-white/90">{disease.summary}</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 p-8">
              ...
              <div className="lg:col-span-2 space-y-8">
                ...
                <section>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="p-4 bg-purple-50 rounded-xl">
                      <h4 className="font-bold text-gray-900 mb-2">
                        {t.detailSections.whyHappens}
                      </h4>
                      <p className="text-sm text-gray-700">
                        {diseaseData?.whyHappens}
                      </p>
                    </div>
                    <div className="p-4 bg-rose-50 rounded-xl">
                      <h4 className="font-bold text-gray-900 mb-2">
                        {t.detailSections.commonSymptoms}
                      </h4>
                      <p className="text-sm text-gray-700">
                ...
                <section>
                  <h3 className="text-2xl font-bold text-gray-900 mb-6">
                    {t.detailSections.symptoms}
                  </h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    {diseaseData?.symptomCards.map((symptom, idx) => (
                      <div
                        key={idx}
                        className="p-4 bg-linear-to-br from-pink-50 to-purple-50 rounded-xl hover:shadow-lg transition-shadow border-2 border-pink-100"
                      >
                        <symptom.icon className="w-8 h-8 text-pink-500 mb-2" />
                        <h4 className="font-bold text-gray-900 text-sm mb-1">
                          {symptom.title}
                        </h4>
                        <p className="text-xs text-gray-600">{symptom.desc}</p>
                      </div>
                    ))}
                  </div>
                </section>
                ...
                <section>
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">
                    {t.detailSections.scientific}
                  </h3>
                  <div className="space-y-3">
                    {diseaseData?.accordion.map((item, idx) => (
                      <div
                        key={idx}
                      ...
                      >
                        <button
                          onClick={() =>
                            setExpandedAccordion(
                              expandedAccordion === idx ? null : idx
                            )
                          }
                        ...
                        >
                          ...
                          <ChevronRight
                            className={`w-5 h-5 text-gray-500 transition-transform ${
                              expandedAccordion === idx ? "rotate-90" : ""
                            }`}
                          />
                        </button>
                ...
                <section>
                  ...
                  <div className="bg-red-50 border-l-4 border-red-500 rounded-xl p-6">
                    ...
                    <ul className="space-y-2">
                      {diseaseData?.doctorWarnings.map((warning, idx) => (
                        <li
                          key={idx}
                ...
                <section>
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">
                    {t.detailSections.checklist}
                  </h3>
                  <div className="bg-linear-to-r from-purple-100 to-pink-100 rounded-2xl p-6 border-2 border-purple-200">
                    <div className="flex items-center gap-3 mb-4">
                      <FileText className="w-8 h-8 text-purple-600" />
                      <h4 className="font-bold text-gray-900">
                        Health Tracking Checklist
                      </h4>
                    </div>
                    ...
                    <div className="flex gap-3">
                      <button className="flex-1 py-3 bg-purple-600 text-white rounded-xl font-semibold hover:bg-purple-700 transition-colors flex items-center justify-center gap-2">
                        <Download className="w-5 h-5" />
                        Download PDF
                      </button>
                      <button className="flex-1 py-3 bg-white border-2 border-purple-300 text-purple-600 rounded-xl font-semibold hover:bg-purple-50 transition-colors flex items-center justify-center gap-2">
              ...
              <div className="lg:col-span-1">
                <div className="sticky top-8">
                  <div className="bg-linear-to-br from-purple-100 to-pink-100 rounded-2xl p-6 border-2 border-purple-300">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="w-12 h-12 bg-purple-500 rounded-full flex items-center justify-center animate-pulse">
                        <Video className="w-6 h-6 text-white" />
                      </div>
                      <h4 className="font-bold text-gray-900">
                        {t.detailSections.video}
                      </h4>
                    </div>
                    ...
                    <p className="text-sm text-gray-700 mb-3">
                      {t.detailSections.watchVideo}
                    </p>
                    <button className="w-full py-2 bg-white border-2 border-purple-300 text-purple-600 rounded-lg font-semibold hover:bg-purple-50 transition-colors text-sm">
                      {t.detailSections.toggleCaptions}
                    </button>

                    <button
                      onClick={() => {
                        window.open(diseaseData?.learnmore, "_blank");
                      }}
                      className="w-full py-2 bg-white border-2 border-purple-300 text-purple-600 rounded-lg font-semibold hover:bg-purple-50 transition-colors text-sm"
                    >
                      Learn More
                    </button>
                    <div className="mt-4 pt-4 border-t-2 border-purple-200">
                      ...
                      <ul className="space-y-2 text-xs text-gray-700">
                        <li className="flex items-start gap-2">
                          ...
                          <span>Affects 1 in 10 women</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <Clock className="w-4 h-4 text-purple-500 shrink-0" />
                          <span>Average diagnosis: 7-10 years</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <TrendingUp className="w-4 h-4 text-purple-500 shrink-0" />
                          <span>Early treatment improves outcomes</span>
                        </li>
                      </ul>
                    </div>
                  </div>
...
export default function DiseaseEducationHub() {
  ...
  const translations = {
    ...
    hi: {
      ...
      heroSubtitle:
        "स्पष्ट स्पष्टीकरण, विश्वसनीय तथ्य, डॉक्टर-अनुमोदित जानकारी।",
      ...
      endometriosis: {
        ...
        whatIs:
          "एक स्थिति जहां एंडोमेट्रियल जैसा ऊतक गर्भाशय के बाहर बढ़ता है।",
        whyHappens:
    ...
    mr: {
      ...
      heroSubtitle:
        "स्पष्ट स्पष्टीकरण, विश्वासार्ह तथ्ये, डॉक्टर-मान्य माहिती।",
      ...
      endometriosis: {
        ...
        whatIs:
          "एक स्थिती जिथे एंडोमेट्रियल सारखी ऊती गर्भाशयाच्या बाहेर वाढते.",
        whyHappens:
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-pink-200 via-lavender-100 to-gray-200">
      {/* Hero Section */}
      <div className="bg-linear-to-r from-pink-400 to-purple-400  py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="relative max-w-2xl">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 rounded-2xl border-2 border-white/30 bg-white/90 backdrop-blur-sm focus:outline-none focus:border-white focus:bg-white transition-all text-gray-900 placeholder-gray-500"
            />
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {filteredDiseases.map((disease) => (
            <button
              ...
              className="text-left bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all transform hover:scale-105 p-6 group"
            >
              <div
                className={`bg-linear-to-br ${disease.color} rounded-2xl p-6 mb-4`}
              >
                <div className="text-6xl mb-3">{disease.emoji}</div>
                <h3 className="text-2xl font-bold text-gray-900 mb-2">
                  {disease.name}
                </h3>
                <p className="text-gray-700">{disease.summary}</p>
              </div>
